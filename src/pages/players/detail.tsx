    ...
    <div>
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center">
          ...
          <h1 className="text-2xl font-bold">
            {t('players.playerDetails', { position: currentPlayer.position })}
          </h1>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-card-bg rounded-lg shadow-md overflow-hidden">
          <div className="bg-darkest-bg p-4 border-b border-gray-700">
            <h3 className="text-gold font-medium">{t('players.basicInfo')}</h3>
          </div>
          
          <div className="p-4">
            <div className="space-y-3">
              <div>
                <span className="text-gray-400 text-sm">{t('players.position')}:</span>
                <p className="font-medium">{currentPlayer.position}</p>
              </div>
              
              <div>
                <span className="text-gray-400 text-sm">{t('players.club')}:</span>
                <p className="font-medium">{currentPlayer.club}</p>
              </div>
              
              <div className="grid grid-cols-3 gap-2">
                <div>
                  <span className="text-gray-400 text-sm block">{t('players.age')}:</span>
                  <p className="font-medium">{currentPlayer.age}</p>
                </div>
                
                <div>
                  <span className="text-gray-400 text-sm block">{t('players.height')}:</span>
                  <p className="font-medium">{currentPlayer.height} cm</p>
                </div>
                
                <div>
                  <span className="text-gray-400 text-sm block">{t('players.weight')}:</span>
                  <p className="font-medium">{currentPlayer.weight} kg</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-card-bg rounded-lg shadow-md overflow-hidden">
          <div className="bg-darkest-bg p-4 border-b border-gray-700">
            <h3 className="text-gold font-medium">{t('players.nationalityInfo')}</h3>
          </div>
          
          <div className="p-4">
            <div className="space-y-3">
              <div>
                <span className="text-gray-400 text-sm">{t('players.nationality')}:</span>
                <p className="font-medium">{currentPlayer.nationality}</p>
              </div>
              
              <div>
                <span className="text-gray-400 text-sm">{t('players.birthplace')}:</span>
                <p className="font-medium">{currentPlayer.birthplace}</p>
              </div>
              
              <div>
                <span className="text-gray-400 text-sm">{t('players.preferredFoot')}:</span>
                <p className="font-medium">{getPreferredFootLabel(currentPlayer.preferredFoot)}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-card-bg rounded-lg shadow-md overflow-hidden">
          <div className="bg-darkest-bg p-4 border-b border-gray-700">
            <h3 className="text-gold font-medium">{t('players.biography')}</h3>
          </div>
          ...
          <div className="p-4">
            {currentPlayer.bio ? (
              ...
              <p className="text-gray-400 italic">{t('players.noBio')}</p>
            )}
          </div>
        </div>
      </div>
